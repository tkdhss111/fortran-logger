#define LOGINI(X) call cf.logger.init ( __FILE__, __LINE__, X )
#define LOGGER(X) call cf.logger.write ( __FILE__, __LINE__, X )
module logger_mo
...
contains
  ...
  function write_args ( x1, x2, x3, x4, x5, x6, x7, x8, x9, x10 ) result ( args )
