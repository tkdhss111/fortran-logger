#define DEBUGLOG(X1) call logger.write ( __FILE__, __LINE__, '*** Debug: ', X1 )
! Not supported in gfortran: #define MYLOG(...) call logger.write ( __FILE__, __LINE__, ##__VA_ARGS__ )
