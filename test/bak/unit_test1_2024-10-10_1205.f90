#define FATAL(X1) call logger.write ( __FILE__, __LINE__, '*** Fatatl: ', X1 )
#define ERROR(X1) call logger.write ( __FILE__, __LINE__, '*** Error: ', X1 )
#define WARNING(X1) call logger.write ( __FILE__, __LINE__, '*** Warning: ', X1 )
